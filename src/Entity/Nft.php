...
use App\Controller\ApiNftController;
...
#[ApiResource(
    collectionOperations: [
        'post' => [
            'controller' => ApiNftController::class,
            'deserialize' => false,
...
class Nft implements SlugInterface
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups([ 'nft:item', 'nft:list', 'coursNft:item', 'coursNft:list', 'acquisition:item', 'acquisition:list', 'groupe:item', 'user:item'])]
    private ?int $id = null;
